  ...
  always @(*) begin
    ...
    case (id_instr_opcode_ip)
      ...
      OPCODE_OP: begin // Register-Register ALU operation
			  ...
			  if (EX_MEM_RegWrite_en && EX_MEM_dest_ip !== 5'd0 && EX_MEM_dest_ip === ID_dest_rs1_ip) begin
					  fa_mux_op = EX_RESULT_SELECT; 
			  end
			  else if (MEM_WB_RegWrite_en && MEM_WB_dest_ip !== 5'd0 && MEM_WB_dest_ip === ID_dest_rs1_ip) begin
					  fa_mux_op = MEM_RESULT_SELECT; 
			  end


			  if (EX_MEM_RegWrite_en && EX_MEM_dest_ip !== 5'd0 && EX_MEM_dest_ip === ID_dest_rs2_ip) begin
					  fb_mux_op = EX_RESULT_SELECT; 
			  end
			  else if (MEM_WB_RegWrite_en && MEM_WB_dest_ip !== 5'd0 && MEM_WB_dest_ip === ID_dest_rs2_ip) begin
